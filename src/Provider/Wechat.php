...
class Wechat extends AbstractProvider
{
    ...
    public function find($order)
    {
        ...
        $this->eventDispatcher->dispatch(new Event\MethodCalled(__CLASS__, __METHOD__, $order));
    ...
    public function close($order): void
    {
        ...
        $this->eventDispatcher->dispatch(new Event\MethodCalled(__CLASS__, __METHOD__, $order, null));
    ...
    {
        $this->eventDispatcher->dispatch(new Event\CallbackReceived(__CLASS__, $contents, $params, null));
